...
double excel_waypoints[19][2] = {{0, 0}, {0, 1000}, {410, 1450}, {1400, 1450}, {1700, 1250}, {2300, 1250}, {4050, 1100}, {4250, 700}, {4100, -1350}, {3400, -1400}, {1500, -1475}, {500, -1475}, {0, 100}, {0, 100}, {0, 100}, {0, 100}, {0, 100}, {0, 100}, {0, 100}};
...
#define S2 1700				//1650 is a creeping speed
#define S3 1750				//This is the speed for negotiating wp's 
#define S4 1910				//1800 is pretty ridiculously fast. Don't use for general use.
...
#define BREAKING_SPEED 2350	//microseconds should be slightly lower in number (i.e. car going faster) than S3 so that the car slows down to S3 and continues at that speed
#define L1 2200
#define L2 5500
#define L3 200
#define L4 350
